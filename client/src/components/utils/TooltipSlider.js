...
const HandleTooltip = (props) => {
  ...
  const restProps = __rest(props, ["value", "children", "visible", "tipFormatter"]);
...
export const handleRender = (node, props) => {
  return (<HandleTooltip value={props.value} visible={true} >
    {node}
  </HandleTooltip>);
};

const TooltipSlider = (_a) => {
  let { tipFormatter, tipProps } = _a
  const props = __rest(_a, ["tipFormatter", "tipProps"]);
